...
"[project]/lib/engines/HospitalMatchingEngine.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function scoreCapability(hospital, issueType) {
...
function scoreBedAvailability(hospital, severity) {
...
function scoreDoctorAvailability(hospital) {
...
function scoreAffordability(hospital, userAffordability) {
    ...
    if (userAffordability === 'budget' && hospital.affordability === 'standard' || userAffordability === 'standard' && (hospital.affordability === 'budget' || hospital.affordability === 'premium')) {
        return 5;
    }
...
function matchHospital(hospitals, patientLocation, issueType, severity, userAffordability) {
    const matches = hospitals.map((hospital)=>{
        ...
        const affordabilityScore = scoreAffordability(hospital, userAffordability);
        // Total score (0-100)
        const totalScore = capabilityScore + bedScore + doctorScore + distanceScore + affordabilityScore;
...
function matchHospitals(hospitals, patientLocation, issueType, severity, userAffordability, topN = 3) {
    const matches = hospitals.map((hospital)=>{
        const distance = calculateDistance(patientLocation, hospital.location);
        const arrivalTime = estimateArrivalTime(distance);
        const capabilityScore = scoreCapability(hospital, issueType);
...
"[project]/lib/utils/incident-utils.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$engines$2f$HospitalMatchingEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/engines/HospitalMatchingEngine.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$incident$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/incident-utils.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(request) {
    try {
        ...
        const incidentId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$incident$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateIncidentId"])();
        // Find best matching hospital
        const bestMatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$engines$2f$HospitalMatchingEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matchHospital"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mockHospitals"], patientLocation, issueType, severity);
        // Create incident
        const incident = {
            id: incidentId,
            ambulanceId,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$incident$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createIncident"])(incident);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            incident,
...
async function GET() {
    try {
        const incidents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$incident$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllIncidents"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            incidents
        }, {
            status: 200
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92bdd9a0._.js.map